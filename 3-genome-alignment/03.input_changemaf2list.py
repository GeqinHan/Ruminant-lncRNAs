...
import sys
@click.command()
@click.option('--maffile', default="sample", help='mfa file')
@click.option('--speciesfile', default="sample", help='species file')
@click.option('--outfile', default="sample", help='out list file')
@click.option('--sp1addlc', default="sample", help='othersp list file')
